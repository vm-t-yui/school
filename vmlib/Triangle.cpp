...
// @brief  マトリクスのセットアップ.
//-----------------------------------------------------------------------------
void Triangle::SetWorldMatrices()
{
...
void Triangle::Render()
{
	...
	GetDxDevice()->SetStreamSource(0, pVB, 0, sizeof(CUSTOMVERTEX));
	GetDxDevice()->SetFVF(D3DFVF_CUSTOMVERTEX);
	GetDxDevice()->DrawPrimitive(D3DPT_TRIANGLELIST, 0, 1);
}